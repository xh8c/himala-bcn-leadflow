          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8 mb-6 md:mb-8">
            <div className="space-y-5 md:space-y-6">
              <div className="flex items-start gap-3 md:gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-foreground text-sm md:text-base mb-1 md:mb-2">Address</h3>
              ...
              <div className="flex items-start gap-3 md:gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-foreground text-sm md:text-base mb-1 md:mb-2">Phone</h3>
              ...
              <div className="flex items-start gap-3 md:gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-foreground text-sm md:text-base mb-1 md:mb-2">Email</h3>
            ...
            <div className="space-y-3 md:space-y-4">
              <h3 className="font-semibold text-foreground text-sm md:text-base mb-3 md:mb-4">Opening Hours</h3>
