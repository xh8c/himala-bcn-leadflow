  ...
  return (
    <section className="relative min-h-[50vh] md:min-h-[70vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center animate-fade-in">
        <h1 className="font-serif text-4xl md:text-7xl lg:text-8xl font-bold text-white mb-4 md:mb-6 tracking-tight">
          Himala BCN
        </h1>
        <p className="font-serif text-xl md:text-4xl text-white/90 italic">
          Calm & Shine
        </p>
      </div>
    </section>
